...
/**
 * JS — HALDiSh plugin that resolves relative link hrefs against the base URL of the
 ...
 * Copy it as a starting point for a JS plugin that needs additional routing logic, e.g.
 * overriding the derived base with `window.location.origin` or a JS environment variable.
 */
