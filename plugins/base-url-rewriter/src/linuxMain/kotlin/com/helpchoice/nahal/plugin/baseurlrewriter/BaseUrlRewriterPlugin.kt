...
/**
 * Linux — HALDiSh plugin that resolves relative link hrefs against the base URL of the
 ...
 * Copy it as a starting point for a Linux plugin that needs additional routing logic, e.g.
 * overriding the derived base with a value from an environment variable or config file.
 */
