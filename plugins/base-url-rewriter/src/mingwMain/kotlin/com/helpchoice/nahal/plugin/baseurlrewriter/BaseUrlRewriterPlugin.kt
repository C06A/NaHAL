...
/**
 * Windows (MinGW) — HALDiSh plugin that resolves relative link hrefs against the base URL
 * of the resource they were taken from.
 *
 ...
 * Copy it as a starting point for a Windows plugin that needs additional routing logic, e.g.
 * overriding the derived base with a value from the Windows Registry or Group Policy.
 */
