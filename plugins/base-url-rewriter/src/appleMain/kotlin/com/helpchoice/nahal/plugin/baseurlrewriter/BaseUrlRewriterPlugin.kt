...
/**
 * Apple (iOS / macOS) — HALDiSh plugin that resolves relative link hrefs against the base
 * URL of the resource they were taken from.
 *
 ...
 * Copy it as a starting point for an Apple plugin that needs additional routing logic, e.g.
 * overriding the derived base with a value from `NSUserDefaults` or an iOS config bundle.
 */
